...
int main() {
    ...
    fprintf(file, "Section t31 with PID = %d\n", getpid());
    sleep(1);

    printf("Section t32 with PID = %d\n", getpid());
    fprintf(file, "Section t32 with PID = %d\n", getpid());
    sleep(1);

    semaphoreV(1);
    semaphoreP(4);

    printf("Section t33 with PID = %d\n", getpid());
    fprintf(file, "Section t33 with PID = %d\n", getpid());
    sleep(1);
